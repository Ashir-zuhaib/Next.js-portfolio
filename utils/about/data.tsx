...
export const timelineItems = [
  ...
  },
  {
    ...
    description:
      'Promoted from intern to senior developer. Built 5+ full-stack applications using Next.js, React, and Node.js. Led development teams, mentored junior developers, and optimized deployment pipelines with Docker and Vercel.',
  },
  {
    year: '2019 - 2023',
...
export const contactLinks = [
  { href: 'mailto:ashirzuhaib2@gmail.com', icon: <EmailIcon />, label: 'Email', value: 'ashirzuhaib2@gmail.com' },
  { href: 'tel:+923142027270', icon: <PhoneIcon />, label: 'Phone', value: '+92 314 2027270' },
  { href: 'https://linkedin.com/in/ashirzuhaib', icon: <LinkedInIcon />, label: 'LinkedIn', value: 'linkedin.com/in/ashirzuhaib', external: true },
  { href: 'https://github.com/Ashir-zuhaib', icon: <GitHubIcon />, label: 'GitHub', value: 'github.com/Ashir-zuhaib', external: true },
];
