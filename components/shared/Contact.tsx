              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex items-center cursor-pointer group" onClick={() => handleCopy('ashirzuhaib2@gmail.com', 'email')}>
                      <p className="text-white font-medium">ashirzuhaib2@gmail.com</p>
                ...
                <div className="flex items-start">
                  ...
                  <div className="flex-1">
                    ...
                    <a href="https://github.com/ashirzuhaib" target="_blank" rel="noopener noreferrer" className="text-white font-medium hover:text-electric-cyan transition-colors">github.com/Ashir-zuhaib</a>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div className="flex-1">
                    ...
                    <a href="https://linkedin.com/in/ashirzuhaib" target="_blank" rel="noopener noreferrer" className="text-white font-medium hover:text-electric-cyan transition-colors">
                      linkedin.com/in/ashirzuhaib
                    </a>
                  </div>
                </div>
              </div>
                ...
                <div className="flex justify-center">
                  <div className="bg-gradient-to-br from-electric-cyan/20 to-blue-500/20 p-6 rounded-lg border border-electric-cyan/30 w-72">
                    <div className="text-center mb-4">
                      ...
                      <h5 className="text-white text-lg font-bold">Ashir Zuhaib</h5>
                    ...
                    <div className="space-y-2 text-sm">
                      <div className="flex items-center">
                        ...
                        <span className="text-slate">ashirzuhaib2@gmail.com</span>
                      </div>
                      <div className="flex items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-electric-cyan mr-2">
                          <path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"></path>
                        ...
                        <span className="text-slate">linkedin.com/in/ashirzuhaib</span>
                      </div>
                      <div className="flex items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-electric-cyan mr-2">
                          <path d="M15 22v-4a4.8 4.8 0 0 0-1-3.5c3 0 6-2 6-5.5.08-1.25-.27-2.48-1-3.5.28-1.15.28-2.35 0-3.5 0 0-1 0-3 1.5-2.64-.5-5.36-.5-8 0C6 2 5 2 5 2c-.3 1.15-.3 2.35 0 3.5A5.403 5.403 0 0 0 4 9c0 3.5 3 5.5 6 5.5-.39.49-.68 1.05-.85 1.65-.17.6-.22 1.23-.15 1.85v4"></path>
                        ...
                        <span className="text-slate">github.com/ashirzuhaib</span>
                      </div>
                    </div>
                  </div>
                </div>
