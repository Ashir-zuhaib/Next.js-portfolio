      ...
      <div className="container mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-6">
            <a href="https://github.com/ashirzuhaib" target="_blank" rel="noopener noreferrer" className="text-pine-200 hover:text-sun-500 transition-colors">
            ...
            <a href="https://linkedin.com/in/ashirzuhaib" target="_blank" rel="noopener noreferrer" className="text-pine-200 hover:text-sun-500 transition-colors">
        ...
        <div className="mt-8 pt-8 border-t border-pine-300/10 text-center">
          <p className="text-pine-200 text-sm">
            &copy; {currentYear} Ashir Zuhaib. All rights reserved.
          </p>
