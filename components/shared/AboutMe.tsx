            ...
            <GlassCard className="lg:col-span-2">
              <div className="max-w-3xl">
                <p className="mb-6 text-lg">
                  I'm <span className="text-mauve font-semibold">Ashir Zuhaib</span>, a Full Stack Developer with 3+ years of experience
                ...
                <p className="mb-6 text-slate">
                  ...
                  I've been promoted from intern to senior developer at Jtechsight, where I've developed 5+ full-stack 
